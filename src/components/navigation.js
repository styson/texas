            ...
            <div className="relative flex h-16 items-center justify-between">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current
                            ? 'text-white dark:text-slate-200 bg-slate-900 dark:bg-slate-500'
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  id="theme-toggle"
                  type="button"
                  class="rounded-lg text-sm p-2.5 text-slate-500 dark:text-slate-400 hover:bg-slate-300 dark:hover:bg-slate-700 
